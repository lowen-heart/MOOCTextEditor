...
public abstract class Document {
	...
	public double getFleschScore() {
		...
		double BASE = 206.835;
		double WORD_LENGTH_PENALTY = 84.6;
		double SENTENCE_LENGTH_PENALTY = 1.015;
		double words = (double)getNumWords();
		double sentences = (double)getNumSentences();
		double syllables = (double)getNumSyllables();
		double fleschScore = BASE - SENTENCE_LENGTH_PENALTY*(words/sentences) - WORD_LENGTH_PENALTY*(syllables/words);
		return fleschScore;
	}
